...
> 
> Java是一门非常优秀的面向对象编程语言.Java有完整的生态，岗位需求量大，是后﻿台开发、安卓开发、大数据开‎发的主流编程语言，因此学习‏资源也很丰富，值得学习！有些大厂虽然不需要员工写Java,但是仍然会招Java开发岗,工作前会进行别的语言的培训,比如伟大的Go语言,总体上来看,就业市场上Java开发的岗位数量还是遥遥领先的,因此推荐想本科就业的同学们学习Java,如果后面想转去学其他语言也可以参照之前学过的知识去理解别的语言,那么接下来进入正题.
